          ...
          <ul class="menu-inner py-1">
              ...
              <ul class="menu-sub" v-show="isActive('category')">
                ...
                <li class="menu-item">
                  <a href="layouts-without-navbar.html" class="menu-link">
                    <div data-i18n="Without navbar">Category List</div>
                  </a>
                </li>
              </ul>
            </li>
              ...
              <ul class="menu-sub" v-show="isActive('purchase')">
                ...
                <li class="menu-item">
                  <a href="pages-misc-under-maintenance.html" class="menu-link">
                    <div data-i18n="Under Maintenance">Purchase List</div>
                  </a>
                </li>
              </ul>
            </li>
              ...
              <ul class="menu-sub" v-show="isActive('sales')">
                ...
                <li class="menu-item">
                  <a href="extended-ui-text-divider.html" class="menu-link">
                    <div data-i18n="Text Divider">Sales Report</div>
                  </a>
                </li>
              </ul>
            </li>
            ...
            <li class="menu-item" :class="{ 'active open': isActive('user') }">
              ...
              <ul class="menu-sub" v-show="isActive('user')">
                ...
                <li class="menu-item">
                  <a href="forms-input-groups.html" class="menu-link">
                    <div data-i18n="Input groups">List</div>
                  </a>
                </li>
              </ul>
            </li>
            ...
            <li class="menu-item" :class="{ 'active open': isActive('report') }">
              ...
              <ul class="menu-sub" v-show="isActive('report')">
                ...
                <li class="menu-item">
                  <a href="forms-input-groups.html" class="menu-link">
                    <div data-i18n="Input groups">Sales Report</div>
                  </a>
                </li>
              </ul>
            </li>
